package zombs 
{
	 ...
	 * @author IJUST
	 */
	public class ScreenDoorZombie extends zomb 
	{
		public var shieldable:Boolean;
		public var shieldHP:int;
		public function ScreenDoorZombie() 
		{
			super();
		}
		...
		{   
			...
			this.zombieType = ZombType._ScreenDoorZombie;
		...
		override public function gethurt(damage:int, hurtType:String = ZombType.Shoot_To_Death, killer:Object=null):void
		{
			if (this.HitTestable)
			{
				if (killer==BulletType._ShroomBullet) 
				{
					this.hp -= damage;
					if (this.hp<=0) 
					{
