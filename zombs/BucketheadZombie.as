package zombs 
{
	 ...
	 * @author IJUST
	 */
	public class BucketheadZombie extends zomb 
	{
		//铁桶僵尸和普通僵尸的惟一区别是他在普通僵尸头上加了一个铁桶，只有铁桶去掉才会对僵尸有实质性的伤害
		//铁桶可以通过打击或者磁力菇去掉
		//shieldable来记录是否铁桶正在起作用
		//那他就多两个状态
		//分别是走路以及打击时的戴不戴铁桶
		public var shieldable:Boolean;
		public var shieldHP:int;
		public function BucketheadZombie() 
		{
			super();
		}
		override protected function addedToStage(e:Event):void 
		{
			this.zombieType = ZombType._BucketheadZombie;
